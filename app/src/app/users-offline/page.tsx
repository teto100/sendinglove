        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-6">
            ...
            <p className="text-yellow-700 text-sm mt-1">
              En modo offline solo puedes consultar usuarios. Para crear/editar necesitas conexión.
            </p>
          </div>
          ...
          {users.length === 0 && (
            <div className="text-center py-12">
              ...
              <h3 className="mt-2 text-sm font-medium text-gray-900">No hay usuarios en caché</h3>
